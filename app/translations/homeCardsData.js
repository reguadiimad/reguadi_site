const i18nData = {
  en: [
    ...
    {
      id: 8, badge: "And More", miniTitle: "Dynamic and flexible", slogan: "Endless possibilities.",
      tags: ["Custom Solutions", "Scalability"],
      desc: "Ready to explore custom solutions tailored to your unique requirements and boldest ideas.",
      footerTitle: "Continuous Innovation", footerNote: "* Tailored to your vision", btn: "Let's Talk",
      icon: "M13 5l7 7-7 7M5 5l7 7-7 7", image: "/images/more.png"
    }
  ],
  ...
  fr: [
    ...
    { 
      id: 3, badge: "Applications Mobiles", miniTitle: "Monde Mobile", slogan: "Performances natives.", 
      tags: ["SwiftUI", "Flutter", "React Native"], 
      desc: "Applications innovantes offrant des performances fluides et une expérience utilisateur naturelle sur iOS et Android.", 
      footerTitle: "Développement", footerNote: "* Expertise multiplateforme", btn: "Découvrir", 
      icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", image: "/Images/iphone.png" 
    },
    { 
      id: 4, badge: "Design Créatif", miniTitle: "L'Esthétique", slogan: "Expérience harmonieuse.", 
      tags: ["Figma", "Procreate", "Canva"], 
      desc: "Fusion de la vision humaine et de la logique numérique grâce à des interfaces interactives précises et intuitives.", 
      footerTitle: "Direction Artistique", footerNote: "* Designs 3D", btn: "Découvrir", 
      icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01", image: "/Images/design.png" 
    },
    { 
      id: 5, badge: "Ingénierie des Données", miniTitle: "Cœur du Système", slogan: "Intégrité des données.", 
      tags: ["PostgreSQL", "MySQL", "SQLite"], 
      desc: "Bases de données relationnelles structurées garantissant la stabilité du système et des performances numériques efficaces.", 
      footerTitle: "Gestion des Données", footerNote: "* Analytics", btn: "Découvrir", 
      icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4", image: "/Images/db.png" 
    },
    { 
      id: 6, badge: "DevOps", miniTitle: "Pipelines", slogan: "Efficacité ininterrompue.", 
      tags: ["GitLab", "Docker", "CI/CD"], 
      desc: "Systèmes d'automatisation avancés pour un déploiement continu, transformant le code en produit final en quelques instants.", 
      footerTitle: "Intégration Continue", footerNote: "* Experts en automatisation", btn: "Découvrir", 
      icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z", image: "/Images/devops.png" 
    },
    { 
      id: 7, badge: "Intelligence Artificielle", miniTitle: "Horizons Futurs", slogan: "Technologies intelligentes.", 
      tags: ["Machine Learning", "Analytics"], 
      desc: "Élargir les horizons logiciels en intégrant des algorithmes d'IA et des solutions d'apprentissage automatique.", 
      footerTitle: "Recherche et Développement", footerNote: "* Technologie de demain", btn: "Découvrir", 
      icon: "M13 10V3L4 14h7v7l9-11h-7z", image: "/Images/ai.png" 
    },
    {
      id: 8, badge: "Et Plus", miniTitle: "Dynamique et flexible", slogan: "Possibilités infinies.",
      tags: ["Solutions Sur Mesure", "Évolutivité"],
      desc: "Prêt à explorer des solutions personnalisées adaptées à vos besoins uniques et à vos idées les plus audacieuses.",
      footerTitle: "Innovation Continue", footerNote: "* Adapté à votre vision", btn: "Parlons-en",
      icon: "M13 5l7 7-7 7M5 5l7 7-7 7", image: "/images/more.png"
    }
  ],
  ...
  ar: [
    {
      id: 1, badge: "تطوير الواجهات", miniTitle: "الواجهة المرئية", slogan: "تجارب ويب غامرة.",
      tags: ["React", "Next.js", "Three.js", "Tailwind"],
      desc: "تصاميم دقيقة وعالية الاستجابة، تتناغم بمرونة مع جميع الشاشات لتقديم تجربة بصرية استثنائية.",
      footerTitle: "هندسة واجهات وتجربة المستخدم", footerNote: "* مدعوم بتقنيات Framer Motion", btn: "اكتشف المزيد",
      icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", image: "/Images/mac.png"
    },
    {
      id: 2, badge: "الواجهة الخلفية", miniTitle: "محرك الأداء", slogan: "بنية برمجية متينة.",
      tags: ["Node.js", "Django", "Laravel"],
      desc: "بنية خوادم آمنة وقابلة للتوسع، مصممة لمعالجة البيانات المعقدة بسرعة فائقة واستقرار تام.",
      footerTitle: "هندسة النظم والبنية التحتية", footerNote: "* قابل للتكامل مع Spring Boot", btn: "اكتشف المزيد",
      icon: "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01", image: "/Images/server.png"
    },
    {
      id: 3, badge: "تطبيقات الهواتف", miniTitle: "عالم الهواتف", slogan: "أداء أصلي وانسيابي.",
      tags: ["SwiftUI", "Flutter", "React Native"],
      desc: "تطبيقات هواتف مبتكرة تقدم أداءً سلساً وتجربة مستخدم طبيعية على منصتي iOS و Android.",
      footerTitle: "تطوير تطبيقات الهواتف الذكية", footerNote: "* خبرة في التطوير متعدد المنصات", btn: "اكتشف المزيد",
      icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", image: "/Images/iphone.png"
    },
    {
      id: 4, badge: "التصميم الإبداعي", miniTitle: "البعد الجمالي", slogan: "تجربة بصرية متناغمة.",
      tags: ["Figma", "Procreate", "Canva"],
      desc: "دمج الرؤية البشرية بالمنطق الرقمي من خلال واجهات تفاعلية عالية الدقة وسهلة الاستخدام.",
      footerTitle: "الإدارة الفنية والإبداعية", footerNote: "* من النماذج الأولية إلى التصاميم ثلاثية الأبعاد", btn: "اكتشف المزيد",
      icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01", image: "/Images/design.png"
    },
    {
      id: 5, badge: "هندسة البيانات", miniTitle: "نواة النظام", slogan: "موثوقية وتكامل البيانات.",
      tags: ["PostgreSQL", "MySQL", "SQLite"],
      desc: "قواعد بيانات علائقية مهيكلة ومحسنة تضمن استقرار النظام وكفاءة الأداء الرقمي.",
      footerTitle: "إدارة وتحليل البيانات", footerNote: "* خبرة معتمدة في التحليلات والرياضيات", btn: "اكتشف المزيد",
      icon: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4", image: "/Images/db.png"
    },
    {
      id: 6, badge: "العمليات التطويرية (DevOps)", miniTitle: "مسارات النشر", slogan: "كفاءة دون انقطاع.",
      tags: ["GitLab", "Docker", "CI/CD"],
      desc: "أنظمة أتمتة متطورة للنشر المستمر، تحول الأكواد البرمجية إلى منتج نهائي في لحظات.",
      footerTitle: "التكامل والتسليم المستمر (CI/CD)", footerNote: "* خبراء في عمليات النشر والأتمتة", btn: "اكتشف المزيد",
      icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z", image: "/Images/devops.png"
    },
    {
      id: 7, badge: "الذكاء الاصطناعي", miniTitle: "آفاق المستقبل", slogan: "تقنيات فائقة الذكاء.",
      tags: ["Machine Learning", "Analytics"],
      desc: "توسيع آفاق التطوير البرمجي عبر دمج خوارزميات الذكاء الاصطناعي وحلول التعلم الآلي.",
      footerTitle: "البحث والتطوير المتقدم", footerNote: "* نصنع تكنولوجيا الغد", btn: "اكتشف المزيد",
      icon: "M13 10V3L4 14h7v7l9-11h-7z", image: "/Images/ai.png"
    },
    {
      id: 8, badge: "والمزيد", miniTitle: "مرونة وديناميكية", slogan: "إمكانيات لا حدود لها.",
      tags: ["حلول مخصصة", "قابلية التوسع"],
      desc: "مستعدون لاستكشاف حلول مخصصة مصممة خصيصاً لتلبية متطلباتك الفريدة وأفكارك الجريئة.",
      footerTitle: "ابتكار مستمر", footerNote: "* مصمم خصيصاً لرؤيتك", btn: "لنتحدث",
      icon: "M13 5l7 7-7 7M5 5l7 7-7 7", image: "/images/moreAr.png"
    }
  ]
};
